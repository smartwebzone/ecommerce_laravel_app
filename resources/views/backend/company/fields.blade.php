...
<div class="form-group col-sm-6">
    ...
    {!! Form::text('phone', null, ['class' => 'form-control','value' => old('phone')]) !!}
</div>
...
<div class="form-group col-sm-6">
    ...
    {!! Form::text('contact_person', null, ['class' => 'form-control','value' => old('contact_person')]) !!}
</div>

<!-- Email Field -->
<div class="form-group col-sm-6">
    {!! Form::label('address1', 'Address 1:') !!}
    {!! Form::text('address1', null, ['class' => 'form-control','value' => old('address1')]) !!}
</div>
<!-- Email Field -->
<div class="form-group col-sm-6">
...
<div class="form-group col-sm-6">
    ...
    {!! Form::text('city', null, ['class' => 'form-control','value' => old('city')]) !!}
</div>
<!-- Email Field -->
<div class="form-group col-sm-6">
    {!! Form::label('state', 'State:') !!}
    {!! Form::text('state', null, ['class' => 'form-control','value' => old('state')]) !!}
</div>
<!-- Email Field -->
<div class="form-group col-sm-6">
    {!! Form::label('zip', 'Zip:') !!}
    {!! Form::text('zip', null, ['class' => 'form-control','value' => old('zip')]) !!}
</div>
<!-- Email Field -->
<div class="form-group col-sm-6">
