...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?=asset('/filemanager/scripts/jquery.contextmenu/dist/jquery.contextMenu.min.css')?>" />
    <link rel="stylesheet" type="text/css" href="<?=asset('/filemanager/scripts/custom-scrollbar-plugin/jquery.mCustomScrollbar.min.css')?>" />
    <link rel="stylesheet" type="text/css" href="<?=asset('/filemanager/scripts/alertify.js/dist/css/alertify.css')?>">
    ...
    <div class="fm-wrapper">
        <div class="fm-header">
            <div class="current-path">
                <h1 itemprop="headline" data-bind="text: lg().current_folder + currentPath()"></h1>
            </div>
            ...
            <div class="fm-fileinfo">
                ...
                <ul class="view-items grid" data-bind="visible: !loadingView() && !previewFile() && viewMode() === 'grid', foreach: {data: itemsModel.objects, as: 'koItem'}">
                    ...
                    <li class="directory-parent" data-bind="click: koItem.open, droppableView: koItem" oncontextmenu="return false;">
                        <div class="clip">
                            <img itemprop="image" src="" class="grid-icon ico_folder_parent" />
                        </div>
                        <p>..</p>
                    </li>
                    <!-- /ko -->
                    ...
                    <li data-bind="click: koItem.open, draggableView: koItem, droppableView: koItem, visible: koItem.visible, attr: {class: koItem.cdo.itemClass, title: koItem.title()}">
                        ...
                        <div class="item-content">
                            <div class="clip">
                                <img itemprop="image" src="" data-bind="css: koItem.gridIconClass(), attr: {src: koItem.cdo.imageUrl, width: koItem.cdo.previewWidth}" />
                            </div>
                ...
                <div class="fm-preview" data-bind="with: previewModel, visible: !loadingView()">
                    ...
                    <div class="fm-preview-viewer">
                        ...
                        <img itemprop="image" src="" data-bind="css: previewIconClass(), attr: {src: viewer().url}" />
                        <!-- /ko -->
                        <!-- ko if: viewer().type === 'editable' -->
                        <img itemprop="image" src="" data-bind="css: previewIconClass(), attr: {src: viewer().url}, visible: !editor.enabled()" />
                        <!-- /ko -->
                    ...
                    <div class="fm-preview-title">
                        <div id="main-title">
                            <h1 itemprop="headline" data-bind="text: rdo.attributes.name, attr: {title: rdo.id}"></h1>
                            <div id="tools">
        ...
        <script type="text/javascript" src="<?=asset('/filemanager/scripts/jquery-1.11.3.min.js')?>"></script>
        <script type="text/javascript" src="<?=asset('/filemanager/scripts/jquery-ui.min.js')?>"></script> <!-- build for drag&drop only -->
        <script type="text/javascript" src="<?=asset('/filemanager/scripts/jquery-browser.js')?>"></script>
        <script type="text/javascript" src="<?=asset('/filemanager/scripts/knockout-3.4.0.js')?>"></script>
        <script type="text/javascript" src="<?=asset('/filemanager/scripts/jquery.splitter/dist/jquery-splitter.js')?>"></script>
        <script type="text/javascript" src="<?=asset('/filemanager/scripts/jquery.contextmenu/dist/jquery.contextMenu.min.js')?>"></script>
        <script type="text/javascript" src="<?=asset('/filemanager/scripts/alertify.js/dist/js/alertify.js')?>"></script>
        <script type="text/javascript" src="<?=asset('/filemanager/scripts/javascript-templates/js/tmpl.min.js')?>"></script>
        <!-- Load filemanager script -->
        <script type="text/javascript" src="<?=asset('/filemanager/scripts/filemanager.min.js')?>"></script>
