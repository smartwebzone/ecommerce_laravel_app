	...
	<script src="{!! asset('/clip/assets/js/bootstrap-toggle.min.js') !!}" type="text/javascript" charset="utf-8"></script>
        ...
        <script src="{!! asset('/clip/assets/plugins/bootstrap-modal/js/bootstrap-modal.js') !!}"></script>
        <script src="{!! asset('/clip/assets/plugins/bootstrap-modal/js/bootstrap-modalmanager.js') !!}"></script>
        <script src="{!! asset('/clip/assets/js/ui-modals.js') !!}"></script>
