    ...
    <tr>
        ...
        <td class="text-center" nowrap="nowrap">
            ...
            <div class='btn-group'>
                ...
                <a target="_blank" href="{!! route('admin.order.invoice', [$order->id]) !!}" class='btn btn-default btn-xs {{($order->status->name == 'Cancelled' ? 'disabled' : '')}}'><i class="glyphicon glyphicon-file"></i></a>
