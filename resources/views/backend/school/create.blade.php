...
{{--    @include('adminlte-templates::common.errors') --}}
                        ...
                        <div class="col-md-12">
                    {!! Form::open(['action' => 'Admin\SchoolController@store', 'method' => 'post', 'files' => true]) !!}

                        @include('backend.school.fields')
...
@section('clipinline')
    ...
    $("input#meta_description").blur(function () {
        $('input#meta_description').val($('input#meta_description').val() + ' by The Jeevandeep School');
    });
@endsection
