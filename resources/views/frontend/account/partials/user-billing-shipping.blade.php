<div class="col-md-6">
    ...
    <div class="col_half {{ $errors->has('billing-form-name')? 'has-error' : '' }}">
        ...
        <p class="help-block"> '.$errors->first('billing-form-name').' </p>
        ':'' !!}
    ...
    <div class="col_half col_last {{ $errors->has('billing-form-lname')? 'has-error' : '' }}">
        ...
        <p class="help-block"> '.$errors->first('billing-form-lname').' </p>
        ':'' !!}
    ...
    <div class="col_full {{ $errors->has('billing-form-companyname')? 'has-error' : '' }}">
        ...
        {!! $errors->has('billing-form-companyname')? '<p class="help-block"> '.$errors->first('billing-form-companyname').' </p> ':'' !!}
    </div>
    ...
    <div class="col_full {{ $errors->has('billing-form-address')? 'has-error' : '' }}">
        ...
        {!! $errors->has('billing-form-address')? '<p class="help-block"> '.$errors->first('billing-form-address').' </p> ':'' !!}
    </div>
    ...
    <div class="col_half  {{ $errors->has('billing-form-city')? 'has-error' : '' }}">
        ...
        {!! $errors->has('billing-form-city')? '<p class="help-block"> '.$errors->first('billing-form-city').' </p> ':'' !!}
    </div>
    <div class="col_half col_last {{ $errors->has('billing-form-state')? 'has-error' : '' }}">
        ...
        <p class="help-block"> '.$errors->first('billing-form-state').' </p>
        ':'' !!}
    </div>
    <div class="col_half  {{ $errors->has('billing-form-country')? 'has-error' : '' }}">
        ...
        {!! $errors->has('billing-form-country')? '<p class="help-block"> '.$errors->first('billing-form-country').' </p> ':'' !!}
    </div>
    <div class="col_half col_last  {{ $errors->has('billing-form-zipcode')? 'has-error' : '' }}">
        ...
        {!! $errors->has('billing-form-zipcode')? '<p class="help-block"> '.$errors->first('billing-form-zipcode').' </p> ':'' !!} </div>
    <div class="clear"></div>
    ...
    <div class="col_half {{ $errors->has('billing-form-email')? 'has-error' : '' }}">
        ...
        {!! $errors->has('billing-form-email')? '<p class="help-block"> '.$errors->first('billing-form-email').' </p> ':'' !!}
    </div>
    ...
    <div class="col_half col_last {{ $errors->has('billing-form-phone')? 'has-error' : '' }}">
        ...
        {!! $errors->has('billing-form-phone')? '<p class="help-block"> '.$errors->first('billing-form-phone').' </p> ':'' !!}
    </div>
...
<div class="col-md-6">
    ...
    <div class="col_half {{ $errors->has('shipping-form-name')? 'has-error' : '' }}">
        ...
        {!! $errors->has('shipping-form-name')? '<p class="help-block"> '.$errors->first('shipping-form-name').' </p> ':'' !!}
    </div>
    ...
    <div class="col_half col_last  {{ $errors->has('shipping-form-lname')? 'has-error' : '' }}">
        ...
        {!! $errors->has('shipping-form-lname')? '<p class="help-block"> '.$errors->first('shipping-form-lname').' </p> ':'' !!}
    </div>
    ...
    <div class="col_full {{ $errors->has('shipping-form-companyname')? 'has-error' : '' }}">
        ...
        {!! $errors->has('shipping-form-companyname')? '<p class="help-block"> '.$errors->first('shipping-form-companyname').' </p> ':'' !!}
    </div>
    ...
    <div class="col_full {{ $errors->has('shipping-form-address')? 'has-error' : '' }}">
        ...
        {!! $errors->has('shipping-form-address')? '<p class="help-block"> '.$errors->first('shipping-form-address').' </p> ':'' !!}
    </div>
    ...
    <div class="col_half {{ $errors->has('shipping-form-city')? 'has-error' : '' }}">
        ...
        {!! $errors->has('shipping-form-city')? '<p class="help-block"> '.$errors->first('shipping-form-city').' </p> ':'' !!}
    </div>
    <div class="col_half col_last {{ $errors->has('shipping-form-state')? 'has-error' : '' }}">
        ...
        <p class="help-block"> '.$errors->first('shipping-form-state').' </p>
        ':'' !!}
    </div>
    <div class="col_half {{ $errors->has('shipping-form-country')? 'has-error' : '' }}">
        ...
        {!! $errors->has('shipping-form-country')? '<p class="help-block"> '.$errors->first('shipping-form-country').' </p> ':'' !!}
    </div>
    <div class="col_half col_last {{ $errors->has('shipping-form-zipcode')? 'has-error' : '' }}">
        ...
        {!! $errors->has('shipping-form-zipcode')? '<p class="help-block"> '.$errors->first('shipping-form-zipcode').' </p> ':'' !!}
    </div>
    <div class="clear"></div>
    ...
    <div class="col_half {{ $errors->has('shipping-form-email')? 'has-error' : '' }}">
        ...
        {!! $errors->has('shipping-form-email')? '<p class="help-block"> '.$errors->first('shipping-form-email').' </p> ':'' !!}
    </div>
    ...
    <div class="col_half col_last {{ $errors->has('shipping-form-phone')? 'has-error' : '' }}">
        ...
        {!! $errors->has('shipping-form-phone')? '<p class="help-block"> '.$errors->first('shipping-form-phone').' </p> ':'' !!}
    </div>
</div>
