...
<div class="wrapper content cf">
    ...
    <div class="enquire login-register cf">
        ...
        <div class="cf">
            ...
            {!! Form::close() !!}
            {!! Form::open(['route' => 'signup',  'id' => 'register-form',  'name' => 'register-form', 'class' => 'loginForm cf',  'method' => 'post']) !!}
                    <input type="hidden" name="redirect" value="{!! @$redirect !!}" class="form-control" />
                    <input type="hidden" name="refrer" value="{!! @$refrer !!}" class="form-control" />
                ...
                <li><a href="validate-email.html" class="btn btnS"><i class="fa fa-link"></i>REGISTER</a>
                	<button type="submit" style="display: none" class="btn btnS"><i class="fa fa-link"></i>REGISTER</button></li>
            </form>
        </div>
    </div>
    <!-- End Select School -->
