        ...
        <div class="cf">
            <table class="cart-table">
                ...
                <tr>
                    ...
                    <td><div><a rel="group" class="thickbox underline" href="{!! route('store.product', [$row->product_id]) !!}?width=905&height=550" title="{!! $row->product()->find($row->product_id)->title !!}"><i class="fa fa-shopping-bag"></i>{{$row->product()->find($row->product_id)->title}}</a></div></td>
                ...
                <tr>
                    ...
                    <td><div><a rel="group" class="thickbox underline" href="{!! route('store.orderproduct', [$om->id]) !!}?width=905&height=550" title="{!! $op->title !!}"><i class="fa fa-shopping-bag"></i>{{$op->title}}</a></div></td>
