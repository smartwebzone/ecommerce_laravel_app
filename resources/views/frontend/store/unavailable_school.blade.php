...
<div class="wrapper content cf">
    ...
    <div class="enquire login-register cf">
        ...
        <div class="select-div">Request to add new School</div>
        ...
        @endif
        <div class="cf">
            {!! Form::open(['route' => 'unavailable_school', 'method' => 'post', 'id' => 'unavailable-school-form',  'name' => 'unavailable-school-form', 'class' => 'loginForm cf validate_form']) !!}    
            ...
            <li class="form-group">
                ...
                <div class="input-group">
                    ...
                    <div class="icon-addon">
                        {!! Form::text('name', null, ['placeholder'=> 'PLEASE ENTER SCHOOL NAME', 'class' => 'form-control required']) !!}
                    </div>
                </div>
