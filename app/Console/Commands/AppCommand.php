...
class AppCommand extends Command
{
	...
	// protected function sentinelCreateBrienUser()
	// {
	// 	$bdata = Sentinel::registerAndActivate([
	// 		'first_name'  => 'Brien',
	// 		'last_name'   => 'Arnold',
	// 		'username'    => 'brien-arnold',
	// 		'slug'        => 'brien-arnold',
	// 		// 'isAdmin'     => '1',
	// 		'email'       => 'brien@graceframe.com',
	// 		'password'    => bcrypt('admin'),
	// 		'activated'   => '1',
	// 		'uuid'        => \Uuid::generate(3, 'brienarnold', Uuid::NS_DNS),
	// 		'referral_id' => null,
	// 		'is_online'   => '0',
	// 		'referred_by' => null,
	// 		'last_login'  => Carbon::now(),
	...
	// 	$brienuser = Sentinel::registerAndActivate($bdata);

	// 	$userInfo = UserInfo::create([
	// 		'user_id'      => $brienuser->id,
	// 		'display_name' => 'Brien'.' '.'Arnold',
	// 		'is_active'    => 1,
	// 		'website'      => 'www.grace.com',
	// 	]);

	// 	$this->role->users()->attach($brienuser);

	// 	$this->comment('');
	// 	$this->info('Briens user was created successfully.');
	// 	$this->comment('');
	// }

	// protected function sentinelCreateChrisUser()
	// {
	// 	$chrisdata = Sentinel::registerAndActivate([
	// 		'first_name'  => 'Chris',
	// 		'last_name'   => 'Svadeen',
	// 		'username'    => 'chris',
	// 		'slug'        => str_slug(('brien arnold'), '-'),
	// 		'isAdmin'     => '1',
	// 		'email'       => 'chris@graceframe.com',
	// 		'password'    => bcrypt('admin'),
	// 		'activated'   => '1',
	// 		'uuid'        => \Uuid::generate(3, 'chriss', Uuid::NS_DNS),
	// 		'referral_id' => null,
	// 		'is_online'   => '0',
	// 		'referred_by' => null,
	// 		'last_login'  => Carbon::now(),
	...
	// 	$user = Sentinel::registerAndActivate($chrisdata);

	// 	$userInfo = UserInfo::create([
	// 		'user_id'      => $user->id,
	// 		'display_name' => 'Chris'.' '.'Svadeen',
	// 		'is_active'    => 1,
	// 		'website'      => 'www.grace.com',
	// 	]);
	...
	// 	$this->comment('');
	// 	$this->info('Chris user was created successfully.');
	// 	$this->comment('');
	// }
	 ...
	 * Create a dummy user.
	 */
	// protected function sentinelCreateGraceUser()
	// {
	// 	$gracedata = Sentinel::registerAndActivate([
	// 		'first_name'     => 'Grace',
	// 		'last_name'      => 'Company',
	// 		'username'       => 'Grace Company',
	// 		'slug'           => str_slug(('grace company'), '-'),
	// 		'isAdmin'        => '1',
	// 		'email'          => 'info@graceframe.com',
	// 		'password'       => bcrypt('contactgrace2016'),
	// 		'activated'      => '1',
	// 		'remember_token' => '',
	...
	// 	]);
	// 	$user = Sentinel::registerAndActivate($gracedata);

	// 	$userInfo = UserInfo::create([
	// 		'user_id'      => $user->id,
	// 		'display_name' => 'The Grace'.' '.'Company',
	// 		'is_active'    => 1,
	// 		'website'      => 'www.grace.com',
	// 	]);
