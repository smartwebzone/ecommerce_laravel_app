...
class ProductsSample extends BaseSample {
  ...
  public function run() {
    ...
    //Create product...set more paramater as required
    $exampleProduct = $this->createExampleProduct($exampleProductId);
    
    
    $this->insertProduct($exampleProduct); //INSERT PRODUCT FEED
  // $this->getProduct($exampleProductId); //GET PRODUCT FEED
   // $this->updateProduct($exampleProduct); //UPDATE PRODUCT FEED
    //$this->deleteProduct($exampleProductId); //DELETE PRODUCT FEED
...
//    }
    ...
    //$exampleProductBatch =        $this->createExampleProducts($exampleProductBatchIDs);
...
//    }
  ...
  private function createExampleProduct($offerId) {
    ...
    $taxes = new Google_Service_ShoppingContent_ProductTax();
            $taxes->setCountry('US');
            $taxes->setRate('5.60');
            $taxes->setRegion('MA');
            $taxes->setTaxShip('Yes');
